function [idxbest, Cbest, sumDbest, Dbest] = kmeansKz(X, k, Cnter, varargin)
%% 扩展的kmeans，设置了初始质心的位置，默认的'start'参数从‘simple’改为'once'
%   初始质心为‘Cnter’；
%%
...
dflts =  {'sqeuclidean' 'once'          []  'singleton'         'on'        []        []        []};
...
if ischar(start)
    startNames = {'uniform','sample','cluster','once'};
