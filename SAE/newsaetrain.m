...
figure; visualize(CJELDeepAE);
% dlmwrite('test.txt',CJEL1);
disp('*****');  
save('D:\Program Files\MATLAB\R2014a\toolbox\final-DeepLearnToolbox-master\data\8SAE200-3lay.mat');
